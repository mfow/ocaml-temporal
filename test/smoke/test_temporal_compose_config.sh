...
require_text 'SMOKE_WORKER_CACHE_EVICTION_DIAGNOSTICS_FILE: /workspace/test/integration/temporal/.cache-eviction-diagnostics.json'
require_text 'SMOKE_CACHE_EVICTION_WORKFLOW_ID: two-binary-sticky-cache-eviction-target'
