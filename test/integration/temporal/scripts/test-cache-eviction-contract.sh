...
require_text "$controller" 'history_response_limit_blocks=8192'
require_text "$controller" 'describe_response_limit_blocks=1024'
require_text "$controller" 'driver_log_limit_blocks=65536'
require_text "$controller" 'ulimit -f "$history_response_limit_blocks" || exit 125'
require_text "$controller" 'ulimit -f "$describe_response_limit_blocks" || exit 125'
require_text "$controller" 'ulimit -f "$driver_log_limit_blocks" || exit 125'
