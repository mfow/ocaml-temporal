...
These six-run cancellation and shutdown assertions are not live evidence yet;
...
failure; the current six-run cancellation assertion is local-only until a
