...
- The two-public-OCaml-binary gate now has eighteen exact terminal assertions:
  ...
  run](https://github.com/mfow/ocaml-temporal/actions/runs/29339077368) verifies all
  eighteen exact results against Temporal Server and PostgreSQL, including the
  larger-backoff retry. The [PR #277
...
all eighteen exact results against Temporal Server 1.31 and PostgreSQL,
including the larger-backoff retry, child-retry, and child-start-failure
markers. The [PR #277 CI
run](https://github.com/mfow/ocaml-temporal/actions/runs/29318684069) remains
