...
remains historical evidence for the original path. The complete [PR #322
run](https://github.com/mfow/ocaml-temporal/actions/runs/29402103748)
live-verifies the separate one-slot sticky-cache eviction gate; other untested
child recovery cases remain deferred even though several of their local worker
paths are already tested. The later
