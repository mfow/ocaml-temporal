...
(** Requests immediate termination of one exact workflow run. A successful
    response is only the server acknowledgement; [Client.wait] observes the
    terminal [Terminated] outcome. *)
